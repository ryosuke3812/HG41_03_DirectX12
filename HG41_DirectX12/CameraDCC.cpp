...
DirectX::XMFLOAT3 CameraDCC::GetPos()
{
	return m_pos;
}
DirectX::XMFLOAT4X4 CameraDCC::GetView(bool transpose)
{
	...
	DirectX::XMStoreFloat4x4(&fMat, mView);
	return fMat;
}
DirectX::XMFLOAT4X4 CameraDCC::GetProj(bool transpose)
{
	...
	DirectX::XMFLOAT4X4 fMat;
	DirectX::XMStoreFloat4x4(&fMat, mProj);
	return fMat;
}
